...
public class psmoveapi_csharp {
  ...
  public static PSMove_Model_Type psmove_get_model(PSMove move) {
    PSMove_Model_Type ret = (PSMove_Model_Type)psmoveapi_csharpPINVOKE.psmove_get_model(PSMove.getCPtr(move));
    return ret;
  }
  ...
  public static PSMove_Bool psmove_host_pair_custom(string addr) {
    PSMove_Bool ret = (PSMove_Bool)psmoveapi_csharpPINVOKE.psmove_host_pair_custom(addr);
    return ret;
  }

  public static PSMove_Bool psmove_host_pair_custom_model(string addr, PSMove_Model_Type model) {
    PSMove_Bool ret = (PSMove_Bool)psmoveapi_csharpPINVOKE.psmove_host_pair_custom_model(addr, (int)model);
    return ret;
  }
  ...
  public static void psmove_util_sleep_ms(SWIGTYPE_p_uint32_t ms) {
    psmoveapi_csharpPINVOKE.psmove_util_sleep_ms(SWIGTYPE_p_uint32_t.getCPtr(ms));
    if (psmoveapi_csharpPINVOKE.SWIGPendingException.Pending) throw psmoveapi_csharpPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void psmove_free_mem(string buf) {
    psmoveapi_csharpPINVOKE.psmove_free_mem(buf);
  }

  public static void psmove_tracker_settings_set_default(PSMoveTrackerSettings settings) {
    psmoveapi_csharpPINVOKE.psmove_tracker_settings_set_default(PSMoveTrackerSettings.getCPtr(settings));
  }

  public static PSMoveTracker psmove_tracker_new() {
    global::System.IntPtr cPtr = psmoveapi_csharpPINVOKE.psmove_tracker_new();
    PSMoveTracker ret = (cPtr == global::System.IntPtr.Zero) ? null : new PSMoveTracker(cPtr, false);
    return ret;
  }

  public static PSMoveTracker psmove_tracker_new_with_settings(PSMoveTrackerSettings settings) {
    global::System.IntPtr cPtr = psmoveapi_csharpPINVOKE.psmove_tracker_new_with_settings(PSMoveTrackerSettings.getCPtr(settings));
    PSMoveTracker ret = (cPtr == global::System.IntPtr.Zero) ? null : new PSMoveTracker(cPtr, false);
    return ret;
  }

  public static PSMoveTracker psmove_tracker_new_with_camera(int camera) {
    global::System.IntPtr cPtr = psmoveapi_csharpPINVOKE.psmove_tracker_new_with_camera(camera);
    PSMoveTracker ret = (cPtr == global::System.IntPtr.Zero) ? null : new PSMoveTracker(cPtr, false);
    return ret;
  }

  public static PSMoveTracker psmove_tracker_new_with_camera_and_settings(int camera, PSMoveTrackerSettings settings) {
    global::System.IntPtr cPtr = psmoveapi_csharpPINVOKE.psmove_tracker_new_with_camera_and_settings(camera, PSMoveTrackerSettings.getCPtr(settings));
    PSMoveTracker ret = (cPtr == global::System.IntPtr.Zero) ? null : new PSMoveTracker(cPtr, false);
    return ret;
  }

  public static int psmove_tracker_count_connected() {
    int ret = psmoveapi_csharpPINVOKE.psmove_tracker_count_connected();
    return ret;
  }
  ...
  public static SWIGTYPE_p_void psmove_tracker_get_frame(PSMoveTracker tracker) {
    global::System.IntPtr cPtr = psmoveapi_csharpPINVOKE.psmove_tracker_get_frame(PSMoveTracker.getCPtr(tracker));
  ...
  public static PSMoveFusion psmove_fusion_new(PSMoveTracker tracker, float z_near, float z_far) {
    global::System.IntPtr cPtr = psmoveapi_csharpPINVOKE.psmove_fusion_new(PSMoveTracker.getCPtr(tracker), z_near, z_far);
    PSMoveFusion ret = (cPtr == global::System.IntPtr.Zero) ? null : new PSMoveFusion(cPtr, false);
    return ret;
  }

  public static SWIGTYPE_p_float psmove_fusion_get_projection_matrix(PSMoveFusion fusion) {
    global::System.IntPtr cPtr = psmoveapi_csharpPINVOKE.psmove_fusion_get_projection_matrix(PSMoveFusion.getCPtr(fusion));
    SWIGTYPE_p_float ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_float(cPtr, false);
    return ret;
  }

  public static SWIGTYPE_p_float psmove_fusion_get_modelview_matrix(PSMoveFusion fusion, PSMove move) {
    global::System.IntPtr cPtr = psmoveapi_csharpPINVOKE.psmove_fusion_get_modelview_matrix(PSMoveFusion.getCPtr(fusion), PSMove.getCPtr(move));
    SWIGTYPE_p_float ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_float(cPtr, false);
    return ret;
  }
  ...
  public static readonly int PSMOVEAPI_VERSION_MAJOR = psmoveapi_csharpPINVOKE.PSMOVEAPI_VERSION_MAJOR_get();
  public static readonly int PSMOVEAPI_VERSION_MINOR = psmoveapi_csharpPINVOKE.PSMOVEAPI_VERSION_MINOR_get();
  public static readonly int PSMOVEAPI_VERSION_PATCH = psmoveapi_csharpPINVOKE.PSMOVEAPI_VERSION_PATCH_get();
  ...
  public static readonly int PSMOVE_TRACKER_DEFAULT_FPS = psmoveapi_csharpPINVOKE.PSMOVE_TRACKER_DEFAULT_FPS_get();
