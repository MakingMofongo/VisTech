...
from ctypes import *
library_prefix = r'C:\Users\Abdul Rasheed\OneDrive\Documents\GitHub\VisTech!\psmove\bindings\python\\'
_psmove = CDLL(library_prefix + 'mover.pyd')
# moveapi.psmove_init(0x030901) #Was using moveapi v 3.9.1
controller = _psmove.psmove_connect()
pass
